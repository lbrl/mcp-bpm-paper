...
The vacuum chamber has a thin mylar film (\SI{0.1}{mm}) window in
...
A fixed fraction of the decay positrons from muons stopped in the
MCP volume go through the mylar film in the side port of the BPM
chamber and give signals to the positron counter. The fraction is
determined in the analysis as described below.
...
the accumulation of 1000 pictures in a two dimensional histogram (top left) were taken
...
\begin{figure}[tbp]
	...
	\caption{Typical CCD images taken with muon beam. Top
          left: accumulation of 1,000 pictures. Top right:
          single picture at high intensity. Bottom left: an
          image taken at the muon beam timing. Bottom right:
