...
\DeclareSIUnit\muonp{\text{\ensuremath{\mu^+}}}
...
\begin{abstract}
  ...
  partial discrimination of positrons from muon decays has
...
beam time window.  The number of total clusters $C_{\text{total}}$ is calculated as $A/a$. In
...
positrons $C_{e}$ is also estimated as $\varepsilon A/a_e$. Then, the
